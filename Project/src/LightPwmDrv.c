...
// T2-C1 Cold White
#define C_LIGHT_PWM_PIN_PORT         GPIOD
#define C_LIGHT_PWM_PIN_ID           GPIO_PIN_4

// T2-C2 Warm White
#define W_LIGHT_PWM_PIN_PORT         GPIOD
#define W_LIGHT_PWM_PIN_ID           GPIO_PIN_3

// T1-C1 Red
#define R_LIGHT_PWM_PIN_PORT         GPIOC
#define R_LIGHT_PWM_PIN_ID           GPIO_PIN_1
...
static void TIM2LightPwm_ClkGpioConfig(void)
{
  ...
  /* TIM1 Channel4,TIM2 Channel1, 2 & TIM3 Channel1, 2 configuration */
  GPIO_Init(C_LIGHT_PWM_PIN_PORT, C_LIGHT_PWM_PIN_ID, GPIO_MODE_OUT_PP_LOW_FAST);
...
static void TIM2PWMFunction_Config(void)
{
  ...
  */
  ...
  TIM1_TimeBaseInit(7, TIM1_COUNTERMODE_UP,TIM2_PWM_PERIOD , 0x00);
  TIM2_TimeBaseInit(TIM2_PRESCALER_8, TIM2_PWM_PERIOD);
  TIM3_TimeBaseInit(TIM3_PRESCALER_8, TIM2_PWM_PERIOD);
  
  TIM1_OC1Init(TIM1_OCMODE_PWM1, TIM1_OUTPUTSTATE_ENABLE,TIM1_OUTPUTNSTATE_ENABLE, 0, TIM1_OCPOLARITY_HIGH,TIM1_OCNPOLARITY_HIGH,TIM1_OCIDLESTATE_RESET,TIM1_OCNIDLESTATE_RESET);
